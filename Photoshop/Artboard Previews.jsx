...
function main() {
    ...
    var win = new Window('dialog', 'Export artboard');
    ...
    win.title = win.g1.add('statictext', undefined, 'Edit Copy');
    ...
    win.g5.spacing = 0;
    if (LSets == 0) {
        win.g5.edittext0 = win.g5.add('edittext {properties: {name: "edittext0"}}', undefined);
        win.g5.edittext0 = "text";
